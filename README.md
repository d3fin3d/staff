...
* __Hiding__
  ...
  If a thread is breaking a rule, it should be hidden. Hidden posts should almost always be infracted/informalled.
  Any subsequent replies to or quotes of the rule breaking post should also be hidden, however they should only
  be infracted/informalled if they have broken a rule. Feel free to ask an admin if you are unsure
  whether to hide/infract a post.
